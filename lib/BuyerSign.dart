...
import 'features/animations/page_transition2.dart';
...
class _SignInState extends State<BuyerSignIn> {
  ...
  void signIn() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if(response.isEmpty){
          floatingSnackBar(
            message: 'Email does not exist as Buyer.',
            context: context,
        ...
        //attempt to sign in with supabase - update
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: loading ? const Loading2(): Scaffold(
